  ...
  return (
    ...
    <div className="user-footer container ">
      <div className="user-footer-about">
        ...
        <p><MdLocationOn /> 95 Obasanjo Way, Lekki, Lagos</p>
        <p><IoIosCall /> +234 675 8935 675</p>
        <p><IoMdMail /> support@rentbetahouse.com</p>
      </div>
      ...
      <div className="user-footer-list d-flex flex-column gap-3"> 
        <h3>Quick Links</h3>
            ...
            <Link to="/inspection" className="text-white">Book Now</Link>
      </div>

      <div>
        <h3>More</h3>
        <Link to="*"><p>Agents</p></Link>
        <Link to="/properties"><p>Affordable Houses</p></Link>
        <Link to="*"><p>FAQ's</p></Link>
      </div>

      <div>
        <h3>Popular Search</h3>
        <Link to="/properties"><p>Apartment for sale</p></Link>
        <Link to="/properties"><p>Apartment for rent</p></Link>
        <Link to="/properties"> <p>3 bedroom flat</p></Link>
        <Link to="/properties"><p>Bungalow</p></Link>
      </div>
      </div>
